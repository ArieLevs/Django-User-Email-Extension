...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(
                    choices=[('ab', 'Abkhazian'), ('aa', 'Afar'), ('af', 'Afrikaans'), ('ak', 'Akan'),
                             ...
                             ('fo', 'Faroese'), ('fj', 'Fijian'), ('fi', 'Finnish'), ('fr', 'French'), ('ff', 'Fulah'),
                             ('gl', 'Galician'), ('ka', 'Georgian'), ('de', 'German'), ('el', 'Greek, Modern (1453–)'),
                             ('gn', 'Guarani'), ('gu', 'Gujarati'), ('ht', 'Haitian, Haitian Creole'), ('ha', 'Hausa'),
                             ('he', 'Hebrew'), ('hz', 'Herero'), ('hi', 'Hindi'), ('ho', 'Hiri Motu'),
                             ('hu', 'Hungarian'),
                             ('ia', 'Interlingua\xa0(International Auxiliary Language Association)'),
                             ('id', 'Indonesian'), ('ie', 'Interlingue, Occidental'), ('ga', 'Irish'), ('ig', 'Igbo'),
                             ...
                             ('ks', 'Kashmiri'), ('kk', 'Kazakh'), ('km', 'Central Khmer'), ('ki', 'Kikuyu, Gikuyu'),
                             ('rw', 'Kinyarwanda'), ('ky', 'Kirghiz, Kyrgyz'), ('kv', 'Komi'), ('kg', 'Kongo'),
                             ('ko', 'Korean'), ('ku', 'Kurdish'), ('kj', 'Kuanyama, Kwanyama'), ('la', 'Latin'),
                             ...
                             ('mt', 'Maltese'), ('mi', 'Maori'), ('mr', 'Marathi'), ('mh', 'Marshallese'),
                             ('mn', 'Mongolian'), ('na', 'Nauru'), ('nv', 'Navajo, Navaho'), ('nd', 'North Ndebele'),
                             ('ne', 'Nepali'), ('ng', 'Ndonga'), ('nb', 'Norwegian Bokmål'),
                             ('nn', 'Norwegian Nynorsk'), ('no', 'Norwegian'), ('ii', 'Sichuan Yi, Nuosu'),
                             ('nr', 'South Ndebele'), ('oc', 'Occitan'), ('oj', 'Ojibwa'), ('cu',
                                                                                            'Church\xa0Slavic, Old Slavonic, Church Slavonic, Old Bulgarian,\xa0Old\xa0Church\xa0Slavonic'),
                             ('om', 'Oromo'), ('or', 'Oriya'), ('os', 'Ossetian, Ossetic'), ('pa', 'Punjabi, Panjabi'),
                             ('pi', 'Pali'), ('fa', 'Persian'), ('pl', 'Polish'), ('ps', 'Pashto, Pushto'),
                             ('pt', 'Portuguese'), ('qu', 'Quechua'), ('rm', 'Romansh'), ('rn', 'Rundi'),
                             ('ro', 'Romanian, Moldavian, Moldovan'), ('ru', 'Russian'), ('sa', 'Sanskrit'),
                             ...
                             ('st', 'Southern Sotho'), ('es', 'Spanish, Castilian'), ('su', 'Sundanese'),
                             ('sw', 'Swahili'), ('ss', 'Swati'), ('sv', 'Swedish'), ('ta', 'Tamil'), ('te', 'Telugu'),
                             ('tg', 'Tajik'), ('th', 'Thai'), ('ti', 'Tigrinya'), ('bo', 'Tibetan'), ('tk', 'Turkmen'),
                             ('tl', 'Tagalog'), ('tn', 'Tswana'), ('to', 'Tonga\xa0(Tonga Islands)'), ('tr', 'Turkish'),
                             ...
                             ('yi', 'Yiddish'), ('yo', 'Yoruba'), ('za', 'Zhuang, Chuang')], default='en', max_length=2,
                    verbose_name='Users Language')),
                ('is_staff',
        ...
        migrations.CreateModel(
            name='PhoneNumber',
            fields=[
                ('number', phonenumber_field.modelfields.PhoneNumberField(max_length=128, primary_key=True, region=None,
                                                                          serialize=False)),
                ('type',
                 models.CharField(choices=[('m', 'Mobile'), ('w', 'Work'), ('h', 'Home'), ('c', 'Car')], default='m',
                                  max_length=1, verbose_name='Phone type')),
                ('verified', models.BooleanField(default=False,
                                                 help_text='Define if this number have been verified (belongs to user). ',
                                                 verbose_name='Verified Status')),
                ('belongs_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                 related_name='phone_number_obj', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('street_name',
                 models.CharField(help_text='Street address, P.O. box, company name, c/o', max_length=128)),
                ('street_number',
                 models.CharField(help_text='Apartment, suite, unit, building, floor, etc.', max_length=64)),
                ...
                ('timezone', models.CharField(
                    choices=[('Africa/Abidjan', 'Africa/Abidjan'), ('Africa/Accra', 'Africa/Accra'),
                             ...
                             ('America/Panama', 'America/Panama'), ('America/Pangnirtung', 'America/Pangnirtung'),
                    ...
                    default='UTC', max_length=32)),
            ],
            options={
                'verbose_name': 'address',
                'verbose_name_plural': 'address',
                'db_table': 'address',
                'unique_together': {('street_name', 'street_number', 'city', 'state', 'country')},
            },
        ),
        migrations.AddField(
            model_name='user',
            name='address',
            field=models.ManyToManyField(to='django_user_email_extension.Address'),
        ),
        migrations.AddField(
            model_name='user',
            name='default_phone_number',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                       to='django_user_email_extension.PhoneNumber'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
