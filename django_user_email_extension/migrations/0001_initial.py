# Generated by Django 3.0.1 on 2020-05-03 18:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified', models.BooleanField(default=False,
                                                 help_text='Define if this number have been verified '
                                                           '(belongs to user). ',
                                                 verbose_name='Verified Status')),
                ('belongs_to',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='phone_number_obj',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('street_name',
                 models.TextField(help_text='Street address, P.O. box, company name, c/o', max_length=128)),
                ('street_number',
